...
```sh
  cd my-folder
  git clone https://github.com/Roseokpe/hello_react_frontend.git
```
...
Feel free to check the [issues page](https://github.com/Roseokpe/hello_react_frontend/issues).
